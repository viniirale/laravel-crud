...
class AdminController extends Controller
{
    ...
    {
        $request->validate([
            'nome-categoria-form' => 'required',
            'status-categoria-form' => 'required',
        ]);
        $categoria = new Categoria();
        $categoria->categoria = $request->input('nome-categoria-form');
    ...
    public function editarCategoria(Request $request, $id){
        ...
        $request->validate([
            'nome-categoria-form-edit-modal' => 'required',
            'status-categoria-form-edit-modal' => 'required',
        ]);
        $categoria = Categoria::findOrFail($id);
        $categoria->categoria = $request->input('nome-categoria-form-edit-modal');
        $categoria->status = $request->input('status-categoria-form-edit-modal');
        $categoria->save();
